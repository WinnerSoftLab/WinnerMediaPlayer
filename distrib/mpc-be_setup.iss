; $Id: WinnerMediaPlayer_setup.iss 4936 2014-06-02 02:26:52Z v0lt $
;
...
#define bindir_x64 = bin_dir + "\WinnerMediaPlayer_x64"
#define bindir_x86 = bin_dir + "\WinnerMediaPlayer_x86"

#ifdef x64Build
  #define bindir       = bin_dir + "\WinnerMediaPlayer_x64"
  #define mpcbe_exe    = "WinnerMediaPlayer64.exe"
  #define mpcbe_ini    = "WinnerMediaPlayer64.ini"
  #define mpcbe_reg    = "WinnerMediaPlayer64"
  #define dxdir        = "DirectX\x64"
  #define BeveledLabel = app_name + " x64 " + app_version_svn
  #define Description  = app_name + " x64 " + app_version
#else
  #define bindir       = bin_dir + "\WinnerMediaPlayer_x86"
  #define mpcbe_exe    = "WinnerMediaPlayer.exe"
  #define mpcbe_ini    = "WinnerMediaPlayer.ini"
  #define mpcbe_reg    = "WinnerMediaPlayer"
...
AppContact={#app_url}
AppCopyright=Copyright © {#copyright_year} Winner Solutions LTD
VersionInfoCompany={#app_name} Team
VersionInfoCopyright=Copyright © {#copyright_year} Winner Solutions LTD
...
Name: "WMPShellExt"; Description: "{cm:comp_WMPShellExt}";  Types: default custom;         Flags: disablenouninstallwarning
...
Source: "{#bindir_x86}\WMPShellExt.dll";                DestDir: "{app}"; Flags: ignoreversion restartreplace uninsrestartdelete; Components: WMPShellExt;
#ifdef localize
...
;[Registry]
;Root: "HKCU"; Subkey: "Software\{#app_name}\ShellExt"; ValueType: string; ValueName: "MpcPath"; ValueData: "{app}\{#mpcbe_exe}"; Flags: uninsdeletekey; Components: WMPShellExt
