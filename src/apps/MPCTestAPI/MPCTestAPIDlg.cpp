...
#if defined (_WIN64)
	m_strMPCPath += _T("WinnerMediaPlayer_x64");
#else
	m_strMPCPath += _T("WinnerMediaPlayer_x86");
#endif // _WIN64
...
#if defined (_WIN64)
	m_strMPCPath += _T("WinnerMediaPlayer64.exe");
#else
	m_strMPCPath += _T("WinnerMediaPlayer.exe");
#endif // _WIN64
