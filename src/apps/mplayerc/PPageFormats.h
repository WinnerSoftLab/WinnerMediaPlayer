...
#define ShellExt	GetModulePath(false) + L"\\WMPShellExt.dll"
#define ShellExt64	GetModulePath(false) + L"\\WMPShellExt64.dll"
...
public:
	...
	static LPCTSTR	GetRegisteredAppName()	{return _T("WinnerMediaPlayer");}
	static LPCTSTR	GetOldAssoc()			{return _T("PreviousRegistration");}
	static LPCTSTR	GetRegisteredKey()		{return _T("Software\\Clients\\Media\\WinnerMediaPlayer\\Capabilities");}
