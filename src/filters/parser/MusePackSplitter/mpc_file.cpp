/*
 *
 * Adaptation for WinnerMediaPlayer (C) 2012 Dmitry "Vortex" Koteroff (vortex@light-alloy.ru, http://light-alloy.ru)
 *
 * This file is part of WinnerMediaPlayer and Light Alloy.
 *
