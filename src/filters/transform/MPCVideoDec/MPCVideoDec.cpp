...
// option names
#define OPT_REGKEY_VideoDec  _T("Software\\WinnerMediaPlayer Filters\\MPC Video Decoder")
...
#ifdef REGISTER_FILTER
#define OPT_REGKEY_VCodecs   _T("Software\\WinnerMediaPlayer Filters\\MPC Video Decoder\\Codecs")
